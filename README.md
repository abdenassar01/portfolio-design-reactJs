...
this Project depends on the styled-components library so once you clone the repository you should run `npm install` or `yarn add` in order to install the dependencies.
